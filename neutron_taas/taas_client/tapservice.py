...
class ListTapService(extension.ClientExtensionList, TapService):
    ...
    list_columns = ['id', 'name', 'port', 'status', 'erspan_dst_ip']
...
class CreateTapService(extension.ClientExtensionCreate, TapService):
    ...
    list_columns = ['id', 'name', 'port', 'erspan_dst_ip']
    ...
    def args2body(self, parsed_args):
        ...
        if parsed_args.erspan_dst_ip:
            body['erspan_dst_ip'] = parsed_args.erspan_dst_ip
