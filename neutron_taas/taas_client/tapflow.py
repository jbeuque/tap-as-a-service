...
class ListTapFlow(extension.ClientExtensionList, TapFlow):
    ...
    list_columns = ['id', 'name', 'source_port', 'tap_service_id', 'erspan_session_id', 'status']
...
class CreateTapFlow(extension.ClientExtensionCreate, TapFlow):
    ...
    list_columns = ['id', 'name', 'direction', 'source_port', 'erspan_session_id']
    ...
    def add_known_arguments(self, parser):
        ...
        parser.add_argument(
            '--erspan_session_id',
            required=False,
            metavar="ERSPAN_SESSION_ID",
            help=_('Session_id of the Erspan tunnel.'))
    ...
    def args2body(self, parsed_args):
        ...
        if parsed_args.erspan_session_id:
            body['erspan_session_id'] = parsed_args.erspan_session_id
